                ...
                <OwlCarousel className="udemyComments__sliders" nav>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">Udemy is a life saver. I don't have the time or money for a college education. My goal is to become a freelance web developer, and thanks to Udemy, I'm really close.</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">I believe in lifelong learning and Udemy is a great place to learn from experts. I've learned a lot and recommend it to all my friends.</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">I work in project management and joined Udemy because I get great courses for less. The instructors are fantastic, interesting, and helpful. I plan to use Udemy for a long time!</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">Thank you Udemy! You've renewed my passion for learning and my dream of becoming a web developer.</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="card-text">The best part about Udemy is the selection. You can find a course for anything you want to learn!</p>
                        </div>
                    </div>
                </OwlCarousel>
            </div>
